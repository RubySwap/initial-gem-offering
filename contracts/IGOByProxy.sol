...
import '@rubyswap/ruby-swap-lib/contracts/utils/ReentrancyGuard.sol';
import "@rubyswap/ruby-swap-lib/contracts/proxy/Initializable.sol";

contract IGOByProxy is ReentrancyGuard, Initializable {
  ...
  event Claim(address indexed user, uint256 offeringAmount, uint256 excessAmount);
  ...
  function claim() public nonReentrant {
    require (block.number > endBlock, 'not claim time');
